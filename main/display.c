...
void SetupDemo( struct SSD1306_Device* DisplayHandle, const struct SSD1306_FontDef* Font ) {
    ...
    SSD1306_SetContrast(DisplayHandle, 250);
}
...
void showText(const char* line1, const char* line2, const char* line3, const char* line4) 
{
    ...
    SSD1306_FontDrawString(&I2CDisplay, 0, 0, line1, SSD_COLOR_WHITE);
    SSD1306_FontDrawString(&I2CDisplay, 0, 14, line2, SSD_COLOR_WHITE);
